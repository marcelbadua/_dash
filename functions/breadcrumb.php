...
function _dash_breadcrumbs() {
    ...
    $delim_before   = ''; // tag before delimiter
    $delim_after    = ''; // tag after delimiter
    ...
    if (is_home() || is_front_page()) {
        ...
        if ( is_category() ) {
            ...
            if ( get_query_var('paged') ) {
                ...
                if ($show_current == 1) echo $delimiter . $before . $term->name . $after;
            }
